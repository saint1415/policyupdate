...
The purpose of this Backup Plan (Plan) is to document the processes related to backing up of {{ORGANIZATION_NAME}}’s Information Systems, storing of backup information, testing of backups, and security related to backups.
...
{{ORGANIZATION_NAME}}’s Backup Policy provides direction and guidance to this Plan and related activities.

## III. Business Continuity Objectives

{{ORGANIZATION_NAME}} is committed to protecting its business operations, investments by its stakeholders, and assets of the organization.  Risks assessments are used as a tool to help identify and mitigate risks to assets.  {{ORGANIZATION_NAME}}’s Risk Assessment Policy specifies that the risk assessment, risk analysis, and risk treatment plan shall be reviewed on an annual basis to ensure that controls are sufficient and effective at treating risks.
...
Backups are an important part of providing Information System availability and are critical to {{ORGANIZATION_NAME}}’s business continuity.  Per the Backup Policy, the {{CSO_TITLE}} (CSO) has performed a review and analysis of our Business Impact Analysis and costs and determined that {{ORGANIZATION_NAME}} shall operate at Tier 2: Data backups with hot site.  See the Backup Policy for more information about the recovery Tiers.

## IV. Responsibilities

The IT Director has been assigned the responsibility of implementing and managing {{ORGANIZATION_NAME}}’s Backup Plan and related processes and procedures.  The IT Director delegates some or all of the following backup related responsibilities to a Backup Coordinator:
...
{{ORGANIZATION_NAME}} performs a full back up each evening for all important systems identified in the Business Impact Analysis.   This ensures:
...
{{ORGANIZATION_NAME}} employs a robust backup and archiving scheme that protects against malware and other types of threats.  A minimum of 14 backups are maintained at any point in time.  Exhibit A – Archiving and Rotation Schedule documents our labeling, archiving, and rotation schedule.
Examples of backups:
...
Backups are retained according to Section V.B. Archiving and Retention.  When backups are no longer needed and/or reach the end of their useful life, they are disposed of per {{ORGANIZATION_NAME}}’s Disposal Policy.
...
Annual review by IT Director or designate to ensure the environment is suitable for storing {{ORGANIZATION_NAME}} backups.
Backups are encrypted to protect against theft and unauthorized access.
...
The off-site environment allows {{ORGANIZATION_NAME}} to meet or exceed specified Recovery Time Objectives outlined in the Business Impact Analysis.
