...
This procedure provides direction and guidance on managing problems that can disrupt ABC Company’s operations and/or adversely affect our image and reputation.

## II. Purpose

The purpose of this procedure is to formally document the series of steps taken to meet the requirements specified in ABC Company's Problem Management Policy.

## III. Scope

This procedure applies to all individuals who manage and are responsible for ABC Company’s Information Resources.

## IV. Procedure

The Chief Security Officer (CSO) ensures:
...
Documentation provides actions to identify and respond to suspected or known problems, mitigate them to the extent practicable, measure harmful effects of known problems, document problems and their outcomes, collect evidence, and provide appropriate reporting to ABC Company management.
...
This procedure is to be distributed to the Chief Security Officer, Company Management, Director of IT, Help Desk, and Security Staff.
Procedure History
References:
