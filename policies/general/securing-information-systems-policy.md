...
Information and physical security help protect ABC Company's Information Resources and ensure system confidentiality, availability, and integrity.

## II. Purpose

This policy helps protect ABC Company’s assets and ensures our ability to continue business operations.
...
ABC Company’s IT Department is responsible for developing, maintaining, and managing a Software Development Life Cycle (SDLC).  Please refer to the Secure Software Development Lifecycle Policy for more information.
...
Where possible, the CSO shall use Certified Information Systems Auditors to audit the security controls of ABC Company’s Information Systems.  Security audits shall be performed on an annual basis or more frequently if major changes occur to Information Resources.  Refer to ABC Company’s Audit Policy for more information.
Monitoring systems and audit trails shall be used to prevent unauthorized personnel from accessing ABC Company’s Information Resources.  Audit trails can also be used as an incident detection and response mechanism.  Refer to the Audit Trails Policy for more information.

### D. General Information Systems Security Procedures

ABC Company recommends common-sense protective measures to reduce the risk of loss, damage, or disclosure of information. The following guidelines identify Information Systems controls that assure that the system is properly used, resistant to disruptions, and reliable.
...
Acquisitions – only hardware or software acquired through ABC Company’s approved policies and procedures may be installed.  Refer to the Acquisitions and Procurement Policy.
...
Training – ABC Company must establish a computer security awareness and training program.  Such a program requires proper planning, implementing, maintaining, and periodic evaluation. Refer to the Security Awareness and Training Policy for more information.
...
ABC Company shall establish and maintain a coordination of ABC Company’s response to computerized and electronic communication systems incidents to enable quicker remediation, information gathering and reporting of infrastructure and security related events.  Refer to the Incident Response Policy for more information.
