...
Least privilege access.  This means of granting access refers to the security objective of granting users only those accesses they need to perform their official duties. Data entry clerks, for example, may not have a need to run E-mail utilization reports.
Competency.  Management shall determine the necessary competency of Staff that affects information security performance and determine the competency needed based on the appropriate education, training, or experience.
