---
id: admin-special-access-policy
title: Admin Special Access Policy
version: 1.0.0
...
The purpose of this policy is to establish the rules for creating, using, monitoring, controlling, and removing accounts with special access privileges.
...
This policy is to be distributed to all IT system administrators and security personnel.
Policy History
References:
COBIT APO01.02, APO01.11, APO14.10, BAI09.03-04, DSS01.05, DSS05.02, DSS05.07
GDPR Article 32
HIPAA 164.312(a)(2)(i)
ISO 27001 A.7.2.1, A.12.4.3
NIST SP 800-37 3.1, 3.3
NIST SP 800-53 AC-2, AC-5, AC-6, AT-3
NIST Cybersecurity Framework PR.AC, PR.AT-2, DE.DP-2, RS.RP-1
PCI 2.2.4.a-c, 6.4.2, 7.1.1-2