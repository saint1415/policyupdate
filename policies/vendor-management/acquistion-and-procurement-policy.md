---
id: acquistion-and-procurement-policy
title: Acquistion and Procurement Policy
version: 1.0.0
...
This policy applies to the Purchasing Department, IT Department, and senior executives.
...
Develop procedures for proposed acquisitions of products and services with estimated values exceeding notification thresholds.
...
The nature and extent of research conducted.
Determine if a benefit analysis was conducted.
Acquisition planning
The adequacy of the acquisition approach including appropriate milestones.
Cost and price estimate for the total planned acquisition.
How the acquisition will be funded and the availability of funding.
Technical, business, management, and other significant considerations.
Any required waivers or deviations.
Documentation to explain why full and open competition procedures do not apply.
Contract Award
The type of business arrangements anticipated (single contract, multiple award, etc.).
The duration of each business arrangement.
Pricing arrangements (fixed price, reimbursements, time and materials, etc.) and deposits.
Risk Management
...
The Purchasing Department shall establish procedures to collect the following types of data on acquisitions of products and services.
The products and serviced purchased.
The total estimate value of the contract.
The type of contract (fixed price, time and materials, etc.).
The department requesting the acquisition.
The extent of competition in making the purchase and the number of offerors.
Whether the acquisition was made from a small business concern, disadvantaged individuals, etc.
Whether the acquisition considered environmentally friendly products and services.
...
All IT related hardware and software will be specified by the IT Director. Hardware and software cannot be purchased without a completed IT procurement authorization form.  This form needs to be completed and signed by the user's line manager.  Upon receipt of the completed form, IT will record the request and the IT Director will make a decision whether to approve, decline or amend the requirements for the purchase of the IT related products and/or services.
If the request is approved, IT will forward the request to the Purchasing Department for fulfillment.
If declined or changed, the IT Director will provide a brief explanation to the requesting manager.
Equipment suppliers may be recommended by the IT Department but may be changed on a periodic basis.
Product Delivery
The IT Department will request that equipment be delivered to the IT Department where it can be checked for damage and compliance with the ordered specification prior to being set up and transported to its final destination.
...
Commercially procured software shall be tested to ensure that the software contains no obvious features that might be detrimental to the security of the information system.
...
This policy is to be distributed to all Vice Presidents, senior executives, the Purchasing Department, and the IT Department.
Policy History
References:
COBIT APO01.03, APO01.11, APO03.06, APO03.08, APO09.05, DSS04.05, DSS05.02
GDPR Article 25
HIPAA 164.308(a)(1)(ii)(A)
ISO 27001 6.1.2, 7.1, A.12.1.2
NIST SP 800-37 2.8
NIST SP 800-53 3.11, CM-8, MP-6
NIST Cybersecurity Framework ID.SC1-2, DE.DP-2, RS.RP-1
PCI A3.1.2.b