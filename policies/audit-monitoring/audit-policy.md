...
Security audits help manage and reduce risks to ABC Company’s Information Resources.  A security auditor, usually an independent third party, evaluates systems for security best practices and compliance with an established set of security requirements.
An independent security audit assists the Chief Security Officer (CSO) in ensuring that security controls and safeguards are appropriate, sufficient, and effective at treating risks.  The CSO shall:
...
Internal vulnerability assessment – layers of defense help protect ABC Company’s internal systems should the external network perimeter be breached.  Internal vulnerability assessments identify weaknesses in the network.
...
Where possible, the CSO shall use Certified Information Systems Auditors to audit the security controls of ABC Company’s Information Systems.  Security audits shall be performed on an annual basis or more frequently if major changes occur to Information Resources.
...
The CSO shall document important findings in the Audit Log Form and The Risk Management Officer shall provide necessary reporting to ABC Company Executive Management.
...
This policy is to be distributed to all ABC Company Department Heads, CSO, Risk Management Officer, and those responsible for information system security.
Policy History
References:
