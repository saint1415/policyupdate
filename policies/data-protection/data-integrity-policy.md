...
Controls and safeguards are needed to protect the integrity of electronic data that is stored, accessed, or transmitted using Information Resources.
...
Each department shall protect electronically stored, accessed, or transmitted data.  Each Department shall implement processes that:
...
HIPAA 164.312(c)(2), 164.312(e)(2)(i)
ISO 27001 A.5.1.1, A.5.1.2, A.6.1.1, A.12.1.1, A.18.1.1, A.18.1.4, A.18.2.2
NIST SP 800-37 P-14
NIST SP 800-53 PM-25, SC-8, SI-1
NIST Cybersecurity Framework PR.AC-5, PR.DS-6, PR.DS-8, DE.DP-2, RS.RP-1
PCI 3.6.5, 4.1, 6.4.6, 10.5, 10.6.1, 11.5, 12.10.5