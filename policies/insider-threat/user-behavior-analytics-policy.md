---
id: user-behavior-analytics-policy
title: User Behavior Analytics Policy
version: 1.0.0
...
This policy establishes requirements for user behavior analytics at {{ORGANIZATION_NAME}}.
...
To establish standards and procedures for user behavior analytics.
