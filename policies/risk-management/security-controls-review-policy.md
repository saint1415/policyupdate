---
id: security-controls-review-policy
title: Security Controls Review Policy
version: 1.0.0
...
Corrective controls – Limit the extent of damage caused by the incident and assist in resuming normal business operations.
Security controls may also be classified according to their nature, for example:
Administrative controls – Safeguards include formal and informal policies, procedures, and security training.
Physical controls – Protection mechanisms that protect physical assets (e.g. access cards, data center server racks, locking cabinets).
Technical controls – Technical safeguards (e.g. logical access controls, passwords, patch management, security assessments)
...
GDPR Article 25, 32
HIPAA 164.308(a)(1)(i), 164.308(a)(8), 164.308(a)(2)
ISO 27001:2013 9.3, A.5.1.2, A.9.1.1, A.18.2
NIST SP 800-37 3.5, 3.7
NIST SP 800-53 All XX-1 controls, CA-2, CA-7
NIST Cybersecurity Framework ID.RM-1, PR.PT-1, DE.CM-8, DE.DP-5
PCI 6.7, 7.3, 8.1, 8.8, 12.5, 12.8