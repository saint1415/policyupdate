---
id: certification-and-accreditation-policy
title: Certification and Accreditation Policy
version: 1.0.0
category: compliance
type: policy
status: active
...
The formal process of Certification and Accreditation (C&A) ensures that a clearly established set of security requirements is developed and implemented and any residual risk is minimized and formally documented.
...
The Certification and Accreditation is a standardized process to ensure that an information system meets documented security requirements throughout its life cycle.  Validating security controls provides the following benefits:
Demonstrates compliance with relevant regulations
Establishes and formally documents security requirements
...
GDPR Article 32
HIPAA 164.308(a)(8)
ISO 27001 9.2, A.12.7
NIST SP 800-37 3.5
NIST SP 800-53 AU-1, AU-3, AU-6, AU-9, AU-11
NIST Cybersecurity Framework ID.SC-4, PR.AC-1, PR.PT-1, DE.DP-2
PCI A3.1.2.b, A3.2.2, A3.2.2.1, A3.2.3, A3.3.2