...
Today's Smartphones include advanced features such as the ability to connect to the Internet, download applications, take videos, use wireless connectivity, access network data, etc.  While Smartphones increase productivity, they also come with risks.
...
Identify applications that allow access to user private information
